...
import cn.itcast.goods.service.BrandService;
...
public class BrandController {
    ...
    public Result<List<Brand>> findBrandByCategory(@PathVariable(value = "id") Integer id){
        List<Brand> list = brandService.findBrandByCategory(id);
        return new Result<List<Brand>>(true, StatusCode.OK, "查询品牌列表成功",list);
    }
}
