...
public class SpuController {
    ...
    public Result put(@RequestBody Long[] ids){
        ...
        return new Result(true, StatusCode.OK, "批量添加成功",count);
    }
    ...
    public Result<Goods> findGoodsById(@PathVariable(value = "id") Long id){
         ...
         Goods list = spuService.findGoodsById(id);
        return new Result<Goods>(true, StatusCode.OK, "根据id查询成功",list);
    }
    ...
    public Result logicDeleteSpu(@PathVariable(value = "id")Integer id){
    ...
    public Result restore(@PathVariable(value = "id") Integer id){
