...
import cn.itcast.goods.dao.BrandMapper;
import cn.itcast.goods.dao.CategoryMapper;
import cn.itcast.goods.dao.SkuMapper;
import cn.itcast.goods.dao.SpuMapper;
import cn.itcast.goods.pojo.*;
...
public class SpuServiceImpl implements SpuService {
    ...
    public void put(Long id) {
        ...
        if (spu.getStatus().equals("0")){
            throw new RuntimeException("未通过审核的商品不能上架！请先通过审核!");
        }
     ...
     */
    @Override
    public void logicDeleteSpu(Integer id) {
        Spu spu = spuMapper.selectByPrimaryKey(id);
