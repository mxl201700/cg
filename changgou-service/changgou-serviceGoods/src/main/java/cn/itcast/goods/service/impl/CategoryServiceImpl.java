...
import cn.itcast.goods.service.CategoryService;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public List<Category> findByParentId(Integer pid) {
        ...
        Category category = new Category();//查询的条件  相当于 where parent_id=0
        category.setParentId(pid);//record.setId(1);//where parent_id=0 and id = 1
